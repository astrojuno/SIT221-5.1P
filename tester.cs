...
namespace DoubleLinkedList
{
    class Tester
    {
        ...
        {
            Console.Write("Checking length...");
            if (certificate.Length != list.Count) return false;
            Console.WriteLine("OK");
            INode<int> node = list.First;
            Console.Write("Checking components: ");
            for (int i = 0; i < certificate.Length; i++)
            {
                Console.Write(certificate[i] + ":" + node.Value + " ");
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                Console.WriteLine("List before: " + list.ToString());
                list.RemoveLast();
                list.RemoveLast();
                list.RemoveLast();
                list.RemoveLast();
                Console.WriteLine("List after: " + list.ToString());
